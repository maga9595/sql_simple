package fgd.mytelegram.sketchware95;
...
public class FancyGifDialog {
    ...
    public static class Builder {
        ...
        public Builder setTitleTextColor(int titleTxtColor) {
            this.titleTxtColor = titleTxtColor;
            return this;
        }

        public Builder setDescriptionTextColor(int desTxtColor) {
        ...
        public FancyGifDialog build() {
            ...
            title1.setTextColor(titleTxtColor);
            message1.setTextColor(desTxtColor);
